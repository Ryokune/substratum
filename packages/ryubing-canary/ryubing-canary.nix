# Taken from https://github.com/NixOS/nixpkgs/blob/fdc7b8f7b30fdbedec91b71ed82f36e1637483ed/pkgs/by-name/ry/ryubing/package.nix#L1
# Modified to use the canary version, which uses dotnet10
...
buildDotnetModule rec {
  ...
  # false as this is canary. we dont care about stability nor do we care about our sanity.
  doCheck = false;
  dotnetFlags = [
